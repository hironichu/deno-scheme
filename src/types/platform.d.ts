...
export declare function register(params: RegisterOptions): Promise<void>; 
export declare function register(params: RegisterOptions, cb: (err?: Error | undefined) => void): void;

export declare function checkifExists(protocol: string): Promise<boolean>;
